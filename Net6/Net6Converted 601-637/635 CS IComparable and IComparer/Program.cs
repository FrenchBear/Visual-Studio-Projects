...
namespace CS635
{
    internal class Program
    {
        private static void Main()
        {
            ...
            List<Entier1> l1 = new() { new Entier1(15), new Entier1(2), new Entier1(1), new Entier1(17), new Entier1(3) };
            ...
            // then on IComparable
            List<Entier3> l3 = new() { new Entier3(15), new Entier3(2), new Entier3(1), new Entier3(17), new Entier3(3) };
