...
' 2006-10-21    FPVI    3.3   Options Multithread, DotNetCalls, NoWidePath
...
Label1:
                ...
                If StrComp(fiSource.Name, fiDest.Name, CompareMethod.Binary) Then
                    ' Should rename
                    sCmd = "ren " & QuoteString(sDest & fiDest.Name) & " " & QuoteString(fiSource.Name)
                    Trace(sCmd)
                    nbFilesRenamed += 1
    ...
    Private Sub MyCopyFile(ByVal sourcePath As String, ByVal destinationPath As String)
        ...
        Else
            ...
            Dim bRet As Integer = CopyFileEx(WidePathString(sourcePath), WidePathString(destinationPath), Nothing, 0, cancel, COPY_FILE_ALLOW_DECRYPTED_DESTINATION)
            If bRet = 0 Then
    ...
    Private Sub MyRenameFile(ByVal targetPath As String, ByVal oldName As String, ByVal newName As String)
        If bDotNetCalls Then
            ...
            End Try
        Else
            Dim bRet As Integer = MoveFile(WidePathString(targetPath & oldName), WidePathString(targetPath & newName))
            If bRet = 0 Then
