...
public class T9Enumerator<T>((T s1, T s2, T s3, T s4, T s5, T s6, T s7, T s8, T s9) bigTuple): IEnumerable<T>
{
    private (T s1, T s2, T s3, T s4, T s5, T s6, T s7, T s8, T s9) localTuple = bigTuple;
