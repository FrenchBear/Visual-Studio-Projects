...
#Region " Code généré par le Concepteur Windows Form "
    ...
    <DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btnListCodecs
        '
        ListCodecsButton.Location = New Point(8, 40)
        ListCodecsButton.Name = "btnListCodecs"
        ListCodecsButton.Size = New Size(120, 23)
        ListCodecsButton.TabIndex = 1
        ListCodecsButton.Text = "List Imaging codecs"
        '
        'Form1
        '
        AutoScaleBaseSize = New Size(5, 13)
        ClientSize = New Size(292, 266)
        Controls.Add(ListCodecsButton)
        Controls.Add(Button1)
        Name = "Form1"
        Text = "TIFF Multiframe"
        ResumeLayout(False)
...
#End Region
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        For i As Integer = 0 To 255
            ...
            g1.DrawString(ChrW(&H251C) & f.GdiCharSet().ToString, f, Brushes.Black, 250 * (1 + (i Mod 6)), CSng(2100 / 255 * i))
        Next
