...
#Region " Code généré par le Concepteur Windows Form "
    ...
    <DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Label2 = New Label
        Label3 = New Label
        btnVérifie = New Button
        PictureBox3 = New PictureBox
        SuspendLayout()
        '
        'btnAnalyse
        '
        btnAnalyse.Location = New Point(128, 24)
        ...
        PictureBox2.Location = New Point(8, 168)
        ...
        'btnEncode
        '
        btnEncode.Location = New Point(128, 168)
        ...
        Label1.Font = New Font("Tahoma", 8.0!, FontStyle.Bold)
        Label1.Location = New Point(8, 8)
        Label1.Name = "Label1"
        Label1.Size = New Size(131, 16)
        Label1.TabIndex = 4
        Label1.Text = "Décodage logo original"
        '
        'Label2
        '
        Label2.AutoSize = True
        Label2.Font = New Font("Tahoma", 8.0!, FontStyle.Bold)
        Label2.Location = New Point(8, 152)
        Label2.Name = "Label2"
        Label2.Size = New Size(110, 16)
        Label2.TabIndex = 5
        Label2.Text = "Encodage logo SGS"
        '
        'Label3
        '
        Label3.AutoSize = True
        Label3.Font = New Font("Tahoma", 8.0!, FontStyle.Bold)
        Label3.Location = New Point(216, 152)
        Label3.Name = "Label3"
        Label3.Size = New Size(195, 16)
        Label3.TabIndex = 8
        Label3.Text = "Décodage du nouveau logo généré"
        '
        'btnVérifie
        '
        btnVérifie.Location = New Point(336, 168)
        btnVérifie.Name = "btnVérifie"
        btnVérifie.TabIndex = 7
        btnVérifie.Text = "Vérifie"
        '
        'PictureBox3
        '
        PictureBox3.BorderStyle = BorderStyle.FixedSingle
        PictureBox3.Location = New Point(216, 168)
...
#Region " Définition tsBmp "
  ...
  "800EFFFFFFFFFFFFFFFFFFFFFFFFFFFF"}
    ...
    Private ReadOnly tsBmp2() As String = {
