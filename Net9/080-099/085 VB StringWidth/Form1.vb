' 85 VB StringWidth
' Essais de mesure de chaîne de caractères
'
' 2003-08-07    PV
...
#End Region
    ...
    Public Shared Sub MeasureStringSizeFFormatInts(e As PaintEventArgs)
        ' Set up string.
    ...
    Public Shared Sub MeasureCharacterRangesRegions(e As PaintEventArgs)
        ' Set up string.
