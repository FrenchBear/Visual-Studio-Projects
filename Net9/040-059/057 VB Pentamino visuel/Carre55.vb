...
Public Class Carre55
    ...
    Public Function B(x As Integer) As Boolean
        Return x <> 0
    End Function
    ...
    Public Sub New(i00 As Integer, i01 As Integer, i02 As Integer, i03 As Integer, i04 As Integer,
...
i20 As Integer, i21 As Integer, i22 As Integer, i23 As Integer, i24 As Integer)
    ...
    Public Function TL(iT As Integer, l As Integer, c As Integer) As Integer
        Select Case iT
            Case 1 : Return c
    ...
    Public Function TC(iT As Integer, l As Integer, c As Integer) As Integer
        Select Case iT
