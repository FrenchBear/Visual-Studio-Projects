...
Friend Module modRenduGraphique
    ...
    Public Sub RGOutput()
        ...
        multi = If(p.bPageEnCouleur, p.imgPage, ImgTo1Bit(p.imgPage))
        ...
        While colPages.Count > 0
            ...
            Dim nextbmp = If(nextpage.bPageEnCouleur, nextpage.imgPage, ImgTo1Bit(nextpage.imgPage))
    ...
    Private Function GetFont() As Font
        If fCurrentFont Is Nothing Then
            ...
            Dim rFontSize As Single = fFontSize * 0.96
    ...
    Public Function DpToPx(l As Integer) As Integer
        Return Int(0.5 + (l / 720 * iDPI))
    End Function

    ' Retourne la taille horizontale du texte en decipoints
    Public Function RGTextOut(sFontName As String, fFontSize As Single, bFontBold As Boolean, bFontItalic As Boolean, bFontUnderline As Boolean, bFontNarrow As Boolean, x As Integer, y As Integer, sText As String) As Integer
    ...
    Public Function RGNextTab(x As Integer) As Integer
    ...
    Public Sub RGRectangle(x As Integer, y As Integer, w As Integer, h As Integer, iFillType As Integer)
        If imgCurrentPage Is Nothing Then CreateNewPage()

        Dim br = If(iFillType = 1, Brushes.White, Brushes.Black)

        graCurrentPage.FillRectangle(br, New RectangleF(DpToPx(x), DpToPx(y), DpToPx(w), DpToPx(h)))
    End Sub

    Public Sub RGPaintBitmap(x As Integer, y As Integer, ByRef tbByte As ArrayList, iWidth As Integer, iHeight As Integer, iDPIRaster As Integer)
    ...
    Public Sub RGPaintBitmap(x As Integer, y As Integer, sNomfic As String)
...
Friend Module modRenduPCL
    Private sPCLText As New StringBuilder

    Public Class PCLState
    ...
    Public Sub PCL38aH(sPosition As String)
    ...
    Public Sub PCL38aV(sPosition As String)
    ...
    Public Sub PCL38aL(iMarge As Integer)
    ...
    Public Sub PCL38dD(iTypeSoul As Integer)
    ...
    Public Sub PCL38dArobas()
        TraceWrite("[Disable Underline]")
        staState.bFontUnderline = False
    End Sub

    ' <Esc>(#U
    Public Sub PCL40U(iJeuCar As Integer)
    ...
    ' <Esc>(s#P
    Public Sub PCL40sP(iType As Integer)
        Select Case iType
            Case 0
    ...
    ' <Esc>(s#B
    Public Sub PCL40sB(iGraise As Integer)
        Select Case iGraise
            Case 0
    ...
    ' <Esc>(s#T
    Public Sub PCL40sT(iFont As Integer)
    ...
    Private ReadOnly rasRaster As New RasterClass

    Public Sub PCL42tR(iResolution As Integer)
    ...
    ' dot = 1/300è de pouce
    Public Sub PCL42pX(sPosition As String)
    ...
    Public Sub PCL42pY(sPosition As Integer)
    ...
    Public Sub PCL42rA(iLeftPos As Integer)
    ...
    Public Sub PCL42bW(iBytes As Integer)
        TraceWrite("[Séquence graphique {0} octets]", iBytes)
    End Sub

    Public Sub PCL42bWData(ByRef tbData() As Byte)
        TraceWrite("[Data: ")
    ...
    Public Sub PCLTildaInsèrePhoto(sNomfic As String)
...
Friend Module modConversionImage1Bit
