...
Friend Module modMainAnaPCL
    ...
    Public Sub Main()
        ...
        If sNomficImage = "" Then
            sNomficImage = If(StrComp(Right(sNomficPCL, 4), ".pcl", CompareMethod.Text) = 0,
                Left(sNomficPCL, Len(sNomficPCL) - 4) & ".tif",
                sNomficPCL & ".tif")
        End If
    ...
    Public Function Analyse(sNomFic As String) As Boolean
