...
Public Class CarButtonsUserControl
    ...
    Public Sub New(iIndex As Integer)
        ...
        For i As Integer = 0 To NumberOfFloors - 1
            ...
            cb = New Button With {
                ...
                .Font = New Font("Arial", 14.25!, FontStyle.Bold, GraphicsUnit.Point, 0),
    ...
    Public WriteOnly Property DoorStatus() As Integer
        Set(value As Integer)
            Select Case value
                ...
                Case Else : lblDoorStatus.Text = "? " & value
            End Select
        End Set
    End Property
    ...
    Public WriteOnly Property Direction() As Integer
        Set(value As Integer)
            Select Case value
                ...
                Case Else : lblDirection.Text = "? " & value
            End Select
        End Set
    End Property
    ...
    Public Property CallStatus(iFloor As Integer) As Boolean
        Get
            Return Controls("btn" & iFloor).BackColor <> SystemColors.Control
        End Get
        Set(value As Boolean)
            Controls("btn" & iFloor).BackColor = IIf(value, Color.Lime, SystemColors.Control)
        End Set
    End Property
End Class
