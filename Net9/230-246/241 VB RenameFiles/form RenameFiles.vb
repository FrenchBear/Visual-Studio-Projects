...
Public Class frmRenameFiles
    ...
    Private Sub frmRenameFiles_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        mobjSubclassedSystemMenu = New SubclassedSystemMenu(Handle.ToInt32, "&About Ĥ Aé♫山𝄞🐗 ←↑→↓ ￩￪￫￬ 🠀🠁🠂🠃 🠄🠅🠆🠇 🠈🠉🠊🠋...")
    End Sub
    ...
    ''' </remarks>
    Public Shared Function sGetReplacement(sFound As String, sReplaceExpression As String)
