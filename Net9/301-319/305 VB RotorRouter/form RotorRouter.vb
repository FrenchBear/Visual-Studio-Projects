...
Public Class frmRotorRouter
    ...
    Private ReadOnly r As Integer = 100
    Private ReadOnly n = 15000
    Private ReadOnly nRefresh = 50      ' Refres every nRefresh passes

    Private ReadOnly picScale As Integer = 2
