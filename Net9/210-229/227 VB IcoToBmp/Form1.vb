...
Public Class Form1
    ...
    Private Const sSource As String = "C:\Development\Icons\Office 2003 Icons\Office 2003 Alpha Icons - ico 8bit"
    Private Const sDest As String = "c:\temp\Office 2003 Alpha Icons (png 8bit)"
    ...
    Public Sub Convert(sFile As String)
        Dim i As Image
