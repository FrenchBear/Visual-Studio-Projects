...
Public Class frmImageTool
    Private imOriginalImage As Image
    ...
    Private Sub tsbZoomReduce_Click(sender As Object, e As EventArgs) Handles tsbZoomReduce.Click
        Dim z, z0 As Integer
        z0 = If(tscboZoom.Text = "Auto", CInt((100 * fRatio) + 0.5), CInt(Val(tscboZoom.Text)))
        z = Int((z0 * 2 / 3) + 0.5)
        If z < 10 Then z = 10
    ...
    Private bMouseCapture As Boolean
    ...
    ' NOT an event proc
    Public Shared Sub SelectionTool_MouseDown(e As MouseEventArgs)
    ...
    ' NOT event proc!
    Public Shared Sub SelectionTool_MouseUp(e As MouseEventArgs)

    End Sub

    ' NOT event proc!
    Public Shared Sub HandTool_MouseUp(e As MouseEventArgs)
