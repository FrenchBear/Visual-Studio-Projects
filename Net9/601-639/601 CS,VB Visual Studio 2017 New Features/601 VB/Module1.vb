...
#Enable Warning BC41009
    ...
    Public Function Tally(values As Object()) As (sum As Integer, count As Integer)        ' tuple types
...
Public Class T9Enumerator(Of T) : Implements IEnumerable(Of T)
    ...
    Private localTuple As (s1 As T, s2 As T, s3 As T, s4 As T, s5 As T, s6 As T, s7 As T, s8 As T, s9 As T)
