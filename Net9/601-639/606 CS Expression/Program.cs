...
public class MyVisitor: ExpressionVisitor
{
    ...
    protected override MemberMemberBinding VisitMemberMemberBinding(MemberMemberBinding node)
    {
        ...
        s++;
        var v = base.VisitMemberMemberBinding(node);
        s--;
        return v;
    }
    ...
    protected override SwitchCase VisitSwitchCase(SwitchCase node)
    {
        ...
        s++;
        var v = base.VisitSwitchCase(node);
        s--;
        return v;
    }
    ...
    protected override CatchBlock VisitCatchBlock(CatchBlock node)
    {
        ...
        s++;
        var v = base.VisitCatchBlock(node);
        s--;
        return v;
    }
    ...
    protected override ElementInit VisitElementInit(ElementInit node)
    {
        ...
        s++;
        var v = base.VisitElementInit(node);
        s--;
        return v;
    }
    ...
    protected override LabelTarget? VisitLabelTarget(LabelTarget? node)
    {
        ...
        s++;
        var v = base.VisitLabelTarget(node);
        s--;
        return v;
    }
    ...
    protected override MemberAssignment VisitMemberAssignment(MemberAssignment node)
    {
        ...
        s++;
        var v = base.VisitMemberAssignment(node);
        s--;
        return v;
    }
    ...
    protected override MemberBinding VisitMemberBinding(MemberBinding node)
    {
        ...
        s++;
        var v = base.VisitMemberBinding(node);
        s--;
        return v;
    }
    ...
    protected override MemberListBinding VisitMemberListBinding(MemberListBinding node)
    {
        ...
        s++;
        var v = base.VisitMemberListBinding(node);
        s--;
        return v;
    }
    ...
    protected override Expression VisitConditional(ConditionalExpression node)
    {
        ...
        s++;
        var v = base.VisitConditional(node);
        s--;
        return v;
    }
    ...
    protected override Expression VisitDebugInfo(DebugInfoExpression node)
    {
        ...
        s++;
        var v = base.VisitDebugInfo(node);
        s--;
        return v;
    }
    ...
    protected override Expression VisitExtension(Expression node)
    {
        ...
        s++;
        var v = base.VisitExtension(node);
        s--;
        return v;
    }
    ...
    protected override Expression VisitInvocation(InvocationExpression node)
    {
        ...
        s++;
        var v = base.VisitInvocation(node);
        s--;
        return v;
    }
    ...
    protected override Expression VisitMemberInit(MemberInitExpression node)
    {
        ...
        s++;
        var v = base.VisitMemberInit(node);
        s--;
        return v;
    }
    ...
    protected override Expression VisitMethodCall(MethodCallExpression node)
    {
        ...
        s++;
        var v = base.VisitMethodCall(node);
        s--;
        return v;
    }
    ...
    protected override Expression VisitParameter(ParameterExpression node)
    {
        ...
        s++;
        var v = base.VisitParameter(node);
        s--;
        return v;
    }
    ...
    protected override Expression VisitRuntimeVariables(RuntimeVariablesExpression node)
    {
        ...
        s++;
        var v = base.VisitRuntimeVariables(node);
        s--;
        return v;
    }
    ...
    protected override Expression VisitTypeBinary(TypeBinaryExpression node)
    {
        ...
        s++;
        var v = base.VisitTypeBinary(node);
        s--;
        return v;
    }
