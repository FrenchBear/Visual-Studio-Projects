...
Friend Class NumTheory
    ...
    ''' </summary>
    Public Shared Function GeneratePrimeListWilson(n As Long) As IEnumerable(Of Long)
    ...
    ''' </summary>
    Public Shared Function NextPrimeWilson(n As Long) As Long
    ...
    ''' </summary>
    Public Shared Function GeneratePrimeListDivision(n As Long) As IEnumerable(Of Long)
        Dim lp As New List(Of Long)
        If n < 2 Then Return lp
        lp.Add(2)
        If n = 2 Then Return lp
    ...
    ''' </summary>
    Public Shared Function GeneratePrimeListSieve(n As Long) As IEnumerable(Of Long)
        Dim lp As New List(Of Long)
        If n < 2 Then Return lp
        lp.Add(2)
        If n = 2 Then Return lp
    ...
    ''' </remarks>
    Public Shared Function GeneratePrimeListSieve2(n As Long) As IEnumerable(Of Long)
        Dim lp As New List(Of Long)
        If n < 2 Then Return lp
        lp.Add(2)
        If n = 2 Then Return lp
    ...
    ''' </remarks>
    Public Shared Function GeneratePrimeListSieve3(n As Long) As IEnumerable(Of Long)
        Dim lp As New List(Of Long)
        If n < 2 Then Return lp
        lp.Add(2)
        If n = 2 Then Return lp
...
NextLoop:
    ...
    ''' </summary>
    Public Shared Function GeneratePrimeListMillerRabin(n As Long) As IEnumerable(Of Long)
        Dim lp As New List(Of Long)
        If n < 2 Then Return lp
        lp.Add(2)
        If n = 2 Then Return lp
    ...
    ''' </summary>
    Public Shared Function NextPrimeMillerRabin(n As Long) As Long
        If n Mod 2 = 0 Then n += 1 Else n += 2
    ...
    ''' </summary>
    Public Shared Function GCD(a As Long, b As Long) As Long
        While b <> 0
            Dim t As Long = b
            b = a Mod b
            a = t
    ...
    Public Shared Function Factors(n As Long) As IEnumerable(Of Long)
