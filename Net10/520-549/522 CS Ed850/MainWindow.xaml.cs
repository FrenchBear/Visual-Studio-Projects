...
{
    internal static RoutedUICommand About = new("À propos de...", "About", typeof(MainWindow), [new KeyGesture(Key.I, ModifierKeys.Control)]);
...
public class DataBag: INotifyPropertyChanged
{
    ...
    public string WindowCaption
        => FileName == null ? "ED850 - (Nouveau)" : "ED850 - " + FileName;
}
