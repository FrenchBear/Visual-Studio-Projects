...
Public Class frmFileSystemWatch
    ...
    Public Sub Trace(sEvent As String, sChangeType As String, sFullPath As String, sName As String, Optional sOldFullPath As String = "", Optional sOldName As String = "")
    ...
    Public Sub ListTrace(sMsg As String)
