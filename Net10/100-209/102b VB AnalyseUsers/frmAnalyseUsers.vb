...
#End Region
    ...
    Public Sub RécupListeSites()
        ...
        For Each objX In objOU
            If CStr(objX.class) = "organizationalUnit" Then
    ...
    Public Sub AnalyseOU(sPos As String, sStart As String)
        ...
        Dim objX As Object
        For Each objX In objOU
            If CStr(objX.class) = "user" Then AnalyseUser(sPos, objX)
        Next

        For Each objX In objOU
            If CStr(objX.class) = "organizationalUnit" AndAlso CStr(objX.ou) <> "global" Then
    ...
    Public Sub AnalyseUser(sPos As String, u As Object)
        ...
        If chkChangeMDPInterdit.Checked Then
            ...
            If CInt(oUser.Get("userFlags") And ADS_USER_FLAG_ENUM.ADS_UF_PASSWD_CANT_CHANGE) <> 0 Then
