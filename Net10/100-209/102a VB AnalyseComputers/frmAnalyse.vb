...
#Region " Code généré par le Concepteur Windows Form "
    ...
    <DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        tabHTML = New TabPage()
        IEDoc = New WebBrowser()
        tabListe = New TabPage()
        lvListe = New ListView()
        chPoste = New ColumnHeader()
        chSite = New ColumnHeader()
        chOU = New ColumnHeader()
        chDescription = New ColumnHeader()
        chWhenCreated = New ColumnHeader()
        chWhenChanged = New ColumnHeader()
        ContextMenuStrip1 = New ContextMenuStrip(components)
        cmdCopie = New ToolStripMenuItem()
        TabControl1.SuspendLayout()
        tabHTML.SuspendLayout()
        tabListe.SuspendLayout()
        ContextMenuStrip1.SuspendLayout()
        SuspendLayout()
        '
        'btnAnalyse
        '
        btnAnalyse.Location = New Point(932, 11)
        btnAnalyse.Name = "btnAnalyse"
        btnAnalyse.Size = New Size(180, 56)
        ...
        lblAnalyse.Location = New Point(10, 19)
        lblAnalyse.Name = "lblAnalyse"
        lblAnalyse.Size = New Size(493, 32)
        lblAnalyse.TabIndex = 0
        lblAnalyse.Text = "Site à analyser dans Workstations && Printers :"
        '
        'txtSite
        '
        txtSite.Location = New Point(586, 11)
        txtSite.Name = "txtSite"
        txtSite.Size = New Size(326, 39)
        txtSite.TabIndex = 1
        '
        'lblLégende
        '
        lblLégende.AutoSize = True
        lblLégende.Location = New Point(10, 79)
        lblLégende.Name = "lblLégende"
        lblLégende.Size = New Size(762, 32)
        lblLégende.TabIndex = 3
        lblLégende.Text = "ou=Workstations && Printers,ou=fr,dc=eame,dc=global,dc=sgs,dc=com"
        '
        'TabControl1
        '
        ...
        TabControl1.Controls.Add(tabHTML)
        TabControl1.Controls.Add(tabListe)
        TabControl1.Location = New Point(10, 117)
        TabControl1.Name = "TabControl1"
        TabControl1.SelectedIndex = 0
        TabControl1.Size = New Size(1410, 1019)
        TabControl1.TabIndex = 5
        '
        'tabHTML
        '
        tabHTML.Controls.Add(IEDoc)
        tabHTML.Location = New Point(8, 46)
        tabHTML.Name = "tabHTML"
        tabHTML.Size = New Size(1394, 965)
        tabHTML.TabIndex = 0
        tabHTML.Text = "Synthèse en couleurs"
        '
        'IEDoc
        '
        IEDoc.Dock = DockStyle.Fill
        IEDoc.Location = New Point(0, 0)
        IEDoc.MinimumSize = New Size(20, 20)
        IEDoc.Name = "IEDoc"
        IEDoc.Size = New Size(1394, 965)
        IEDoc.TabIndex = 0
        '
        'tabListe
        '
        tabListe.Controls.Add(lvListe)
        tabListe.Location = New Point(8, 46)
        tabListe.Name = "tabListe"
        tabListe.Size = New Size(1680, 1345)
        tabListe.TabIndex = 1
        tabListe.Text = "Liste"
        '
        'lvListe
        '
        lvListe.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom _
            Or AnchorStyles.Left _
            Or AnchorStyles.Right
        lvListe.Columns.AddRange((New ColumnHeader() {chPoste, chSite, chOU, chDescription, chWhenCreated, chWhenChanged}))
        lvListe.FullRowSelect = True
        lvListe.GridLines = True
        lvListe.Location = New Point(20, 19)
        lvListe.Name = "lvListe"
        lvListe.Size = New Size(1623, 1236)
        lvListe.TabIndex = 0
        lvListe.UseCompatibleStateImageBehavior = False
        lvListe.View = View.Details
        '
        'chPoste
        '
        chPoste.Text = "Computer"
        chPoste.Width = 80
        '
        'chSite
        '
        ...
        chDescription.Width = 260
        '
        'chWhenCreated
        '
        chWhenCreated.Text = "WhenCreated"
        chWhenCreated.Width = 115
        '
        'chWhenChanged
        '
        chWhenChanged.Text = "WhenChanged"
        chWhenChanged.Width = 115
        '
        'ContextMenuStrip1
        '
        ...
        ContextMenuStrip1.Size = New Size(290, 42)
        '
        'cmdCopie
        '
        cmdCopie.Name = "cmdCopie"
        cmdCopie.Size = New Size(289, 38)
        cmdCopie.Text = "Copie toute la liste"
        '
        'frmAnalyse
        '
        AutoScaleBaseSize = New Size(12, 32)
        ClientSize = New Size(1431, 1140)
        ...
        Name = "frmAnalyse"
        Text = "Analyse les objets Computer dans AD"
        TabControl1.ResumeLayout(False)
        tabHTML.ResumeLayout(False)
        tabListe.ResumeLayout(False)
...
#End Region
    ...
    Private Const sStartSite As String = "ou=Workstations & Printers,ou=fr,dc=eame,dc=global,dc=sgs,dc=com"

    ' Expressions régulières pour séparer les machines en listes séparées
    Private ReadOnly r00, r95, r98 As Regex

    Private ReadOnly rNum As Regex                   ' Pour extraire le n°
    ...
    Private ReadOnly slSitesAD As New SortedList
    ...
    ' La chaîne finale
    Private sHTML As StringBuilder

    ' Les couleurs utilisées pour les sous-OU
    Private ReadOnly tColor As Color() = {Color.Pink, Color.Gold, Color.Chartreuse, Color.Aqua, Color.Violet, Color.LightCoral, Color.CornflowerBlue, Color.Wheat, Color.LightGray, Color.OrangeRed, Color.MediumOrchid, Color.LightGray}
...
#End If
    ...
    Public Function ListeOU(sOU As String, sStart As String) As Boolean
        Dim objOU As Object
        Try
    ...
    Public Sub AfficheMachines(slOU As SortedList, slComputers As SortedList, sSite As String, bListeXX As Boolean)
    ...
    ' Ajout d'une machine
    Public Sub aj(sPos As String, sComputer As String, sDescription As String, sWhenCreated As String, sWhenChanged As String)
        sPos = LCase(sPos)
        ...
        If r95.IsMatch(sComputer) And StrComp(sKey, Mid(sComputer, 3, 3), CompareMethod.Text) = 0 Then
            If Not sad.slComp95.ContainsKey(sComputer) Then sad.slComp95.Add(sComputer, theComputer)
        ElseIf r98.IsMatch(sComputer) And StrComp(sKey, Mid(sComputer, 3, 3), CompareMethod.Text) = 0 Then
            If Not sad.slComp98.ContainsKey(sComputer) Then sad.slComp98.Add(sComputer, theComputer)
        ElseIf r00.IsMatch(sComputer) And StrComp(sKey, Mid(sComputer, 3, 3), CompareMethod.Text) = 0 And Mid(sComputer, 6, 2) <> "99" And Mid(sComputer, 6, 4) <> "0000" Then
