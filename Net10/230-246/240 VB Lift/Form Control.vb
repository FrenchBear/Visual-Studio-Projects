...
Public Class frmControl
    ...
    Private Sub frmControl_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        For i As Integer = 0 To NumberOfCars - 1
            ...
            cb.CarPosition = "Floor " & tCar(i).iFloor
    ...
    Private llEvents As LinkedList(Of LiftEvent)

    Public Sub SetInMotion(iCar As Integer)
...
Friend Class LiftEvent
    Public Enum LiftEventType As Integer
        letDoorOpened
        letDoorClosed
        letFloorContact
    End Enum
