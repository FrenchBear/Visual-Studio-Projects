...
Public Class Form1
    Private picBitmap As Bitmap
    Private g As Graphics

    Private ReadOnly Black As Color = Color.Black
    Private ReadOnly White As Color = Color.White

    ' Paramétrage du dessin
    Private Const k1_init As Single = 0.05       ' Marge des petits carrés

    Private Const k2_init As Single = 0.27        ' Taille d'un petit carré

    Private k1 As Single = k1_init
    Private k2 As Single = k2_init
