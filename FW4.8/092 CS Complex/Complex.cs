...
namespace CS92
{
    public readonly struct Complex
    {
        ...
        public static Complex operator *(Complex a, double d) => new Complex(a.r * d, a.i * d);

        public static Complex operator *(double d, Complex a) => new Complex(a.r * d, a.i * d);
        ...
        public static Complex Ln(Complex c) => new Complex(Math.Log(Math.Sqrt(c.r * c.r + c.i * c.i)), Math.Atan2(c.i, c.r));
