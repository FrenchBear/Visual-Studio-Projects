...
' S repr�sente la s�quence Précédente, ~S la s�quence Précédente invers�e (lecture ordre inverse,
' et permutation des - et +
'
' Dans les Règles, S repr�sente la s�quence Précédente, ~S la s�quence Précédente invers�e
' + ou tourne dans le sens trigo, - dans le sens horaire, F dessine un trait
' Peano:  Angle 4, Départ: +F-F-F+, r�gle: S=+~SF-SFS-F~S+
' Dragon: Angle 8, Départ: F, r�gle: S=+S--~S+
'
