...
' 2012-02-25	PV  VS2010  + for�age en 32-bit
...
#Region "Code g�n�r� par le Concepteur Windows Form "
    ...
    Public WithEvents ScriptControl1 As AxMSScriptControl.AxScriptControl
    ...
    <DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        CType(Me.ScriptControl1, ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'Command5
        '
        ...
        Me.ScriptControl1.Location = New Point(264, 8)
        Me.ScriptControl1.Name = "ScriptControl1"
        Me.ScriptControl1.OcxState = CType(resources.GetObject("ScriptControl1.OcxState"), AxHost.State)
        Me.ScriptControl1.Size = New Size(38, 38)
        Me.ScriptControl1.TabIndex = 5
        '
        'frmTestScripting
        '
        ...
        CType(Me.ScriptControl1, ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private Sub Command4_Click(eventSender As System.Object, eventArgs As EventArgs) Handles Command4.Click
        ...
        modX.AddCode(strX)
        Dim objX As Object
        ' Affecter le CodeObject � la variable, puis
    ...
    Private Sub Command5_Click(eventSender As System.Object, eventArgs As EventArgs) Handles Command5.Click
        ...
        script = "Sub TestWord()" & vbCrLf & "dim wd" & vbCrLf & "Set wd = CreateObject(""Word.application"")" & vbCrLf & "wd.Visible = True" & vbCrLf & "wd.Documents.Add" & vbCrLf & "wd.Selection.TypeText (""Il �tait un petit navire"")" & vbCrLf & "wd.Selection.TypeParagraph" & vbCrLf & "End Sub"
    ...
    Private Sub EvalFunc()
        ...
        ' Ajouter le code puis ex�cuter la fonction.
