...
Module modPCL
    ...
    Sub AnaPCLEscape(b As Byte)
        ...
        ' Cas d'une s�quence Terminée par une minuscule suivie de Echap ou Entr�e ou EOF (0x1b=26) -> on resynchronise en silence
        If b = 27 Then
            epclEtat = EtatPCL.epclEscape
            Exit Sub
        End If
        ...
        ' bMainFunction est Défini apr�s le traitement de cette m�me fonction, et en minuscules
...
Module modMacros
    ...
    Sub PCL38fX(iFonction As Integer)
        Select Case iFonction
            Case 0
                ...
                If bDebugMacros Then Console.WriteLine("D�but enregistrement macro {0}", iMacroID)
    ...
    Private Sub RunMacro(sAction As String)
        ...
        If bDebugMacros Then Console.WriteLine("D�but {0} macro {1}", sAction, iMacroID)
...
Module modTilda
    ...
    Sub TildaExecute()
        If bDebugTilda Then Console.WriteLine("<Ex�cution s�quence tilda '{0}'>", sTildaText.ToString)
