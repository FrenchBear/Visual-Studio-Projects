...
<Assembly: AssemblyTitle("AnalysePCL")>
<Assembly: AssemblyDescription("D�codage de PCL et Génération de TIFF")>
<Assembly: AssemblyCompany("")>
<Assembly: AssemblyProduct("AnalysePCL")>
<Assembly: AssemblyCopyright("(c) 2003-2017 Pierre Violent")>
<Assembly: AssemblyTrademark("")>
<Assembly: CLSCompliant(True)>

'Le GUID suivant est pour l'ID de la typelib si ce projet est expos� � COM
<Assembly: Guid("5F078B4C-1893-4238-B6D4-2D5D41A23B16")>
