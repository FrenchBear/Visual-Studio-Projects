...
#Region " Code g�n�r� par le Concepteur Windows Form "
    ...
    <DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Button1.Text = "Thread.Start + classe sp�cifique"
        '
        'Button2
        '
        ...
        Me.Label1.Text = "Cr�ation de threads :"
        '
        'Button4
        '
        ...
        Me.Button4.Text = "Queue synchronis�e"
        '
        'Label2
        '
...
#End Region
    ...
    ' 1. Utilisation d'une classe sp�cifique et de Thread.Start
    Private Sub Button1_Click(sender As System.Object, e As EventArgs) Handles Button1.Click
        ...
        Thread1.Start()
        Thread1.Join()
        MsgBox("Thread1 a retourn� " & tskTâche.bValRet)
    End Sub
    ...
    Sub MaTâche1(StateObjet As Object)
    ...
    Sub MaTâche2(StateObjet As Object)
        Dim stObj As StateObjet
        stObj = CType(StateObjet, StateObjet)
        MsgBox("sArg: " & stObj.sArg)
        MsgBox("iArg: " & stObj.iArg)
    ...
    Sub OnComplete(ar As IAsyncResult)
        '...
    End Sub
...
Class AsyncTest
    ...
    Sub Tâche(arg As Object)
        MsgBox("D�but du thread")
