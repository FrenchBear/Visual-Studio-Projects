' AnalyseAD
' 10/02/2004 PV
' Analyse et repr�sente visuellement les objets AD computer et les OUs dans lesquels ils sont stock�s
' 11/02/04 1.1  Pr�sentation en tableau
...
#Region " Code g�n�r� par le Concepteur Windows Form "
    ...
    <DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.lblAnalyse.Text = "Site � analyser dans Workstations && Printers :"
        '
        'txtSite
        '
        ...
        Me.tabHTML.Text = "Synth�se en couleurs"
        '
        'IEDoc
        '
        ...
        '
        Me.cmdCopie.Index = 0
        Me.cmdCopie.Text = "&Copie la liste enti�re"
        '
        'frmAnalyse
        '
...
#End Region
    ...
    ' Expressions r�guli�res pour s�parer les machines en listes s�par�es
    ...
    ' La liste des sites, lis�e par site. Clé=code site en minuscules, ex: cch
    ReadOnly slSitesAD As New SortedList

    ' Un ordinateur, dans les listes slComp
    Class Computer
        Public iRang As Integer         ' Partie num�rique du nom
    ...
    ' Les couleurs utilis�es pour les sous-OU
...
#End If
    ...
    Function ListeOU(sOU As String, sStart As String) As Boolean
        ...
        Catch e As Exception
            MsgBox("�chec lors de l'acc�s � l'objet Active Directory" & vbCrLf & "LDAP://" & sStart & vbCrLf & vbCrLf & e.Source & ": " & e.Message, MsgBoxStyle.Exclamation)
            IEDoc.Document.body.innerHTML = "�chec lors de l'acc�s � l'objet Active Directory"
            Return False
        End Try
    ...
    Sub Test()
        ...
        aj("\bas", "FRBAS0002", "IBM M42, Serge R�billou", "", "")
        ...
        aj("\bas", "FRBAS0014", "HP VL400, C�line Schlur", "", "")
        aj("\bas", "FRBAS0015", "HP VL400, Chimistes Crepin", "", "")
        aj("\bas", "FRBAS0016", "HP VL400, Contr�leurs Usine Saipol", "", "")
        aj("\bas", "FRBAS0017", "IBM T40, Serge R�billou", "", "")
        aj("\bay", "FRBAY0001", "HP , Carole Foury tba", "", "")
        aj("\bay", "FRBAY0002", "HP , Contr�leurs AGR", "", "")
        ...
        aj("\bor", "FRBOR0001", "IBM T40, Serge REBILLOU (Pr�t,"","")", "", "")
        aj("\bro", "FRBRO0001", "Ta�wanais, Christophe BALIGAN", "", "")
        aj("\bro", "FRBRO0004", "IBM M42, Fabien TOLLET", "", "")
        aj("\bro", "FRBRO0005", "IBM M42, Lo�c THOMAS", "", "")
        ...
        aj("\cch", "FRCCH0138", "IBMT40, Pr�t du service Informatique", "", "")
        ...
        aj("\cch\fin", "FRCCH0021", "IBM M42, Fran�oise Heurtier (NT4,"","")", "", "")
        aj("\cch\fin", "FRCCH0024", "IBM M42, Claire DUBOIS", "", "")
        aj("\cch\fin", "FRCCH0025", "IBM M42, C�dric Limbertie", "", "")
        aj("\cch\fin", "FRCCH0026", "HP Vectra, Laurence Boulanger", "", "")
        aj("\cch\fin", "FRCCH0027", "IBM T30, J�rome RAVET", "", "")
        ...
        aj("\cch\fin", "FRCCH0058", "IBM M42, B�atrice LANGLET", "", "")
        ...
        aj("\cch\fin", "FRCCH9803", "HP Vectra, C�cile BRETON", "", "")
        aj("\cch\hr", "FRCCH0009", "HP Omnibook XE3, V�ronique COTELLE", "", "")
        ...
        aj("\cch\it", "FRCCH0010", "HP, Fay�al Bengatta", "", "")
        ...
        aj("\cch\it", "FRCCH0036", "HP VECTRA, Salle Pr�paration (GOST,"","")", "", "")
        ...
        aj("\cch\ogc", "FRCCH0030", "HP VECTRA, Na�ma GRONDIN", "", "")
        ...
        aj("\cch\ssc", "FRCCH0041", "IBM T30 Fran�ois SECCHI", "", "")
        aj("\cch\ssc", "FRCCH0042", "IBM T40, V�ronique LOMBREY", "", "")
        aj("\cch\ssc", "FRCCH0043", "HP Vectra 420TD, Phillipe FUSILLER", "", "")
        aj("\cch\ssc", "FRCCH0046", "IBM T40, Mickael GENDROT", "", "")
        aj("\cch\ssc", "FRCCH0050", "IBM M42, V�ronique MADRANGE", "", "")
        ...
        aj("\cch\ssc", "FRCCH0100", "Tecra portable, S Dalboussi�re", "", "")
        ...
        aj("\cch\ssc", "FRCCH0134", "IBM M42,C�cile DA ROSA FERREIRA", "", "")
        ...
        aj("\cch\ssc", "FRCCH0145", "IBM M42, Int�rimaire 1 ICS", "", "")
        aj("\cch\ssc", "FRCCH0162", "IBMT30, Etienne NOUAT", "", "")
        aj("\cch\ssc", "FRCCH0163", "TOSHIBA TECRA 8100, Jean SABLON", "", "")
        aj("\cch\ssc", "FRCCH0170", "IBM T30, C�line RAFFARD", "", "")
        aj("\cch\ssc", "FRCCH0171", "IBM M42, Val�rie JOLIBOIS", "", "")
        aj("\cch\ssc", "FRCCH0192", "IBM T30, Flore LAPORTE FAURET", "", "")
        aj("\cch\ssc", "FRCCH0193", "TOSHIBA, Jean-Michel DELINDE", "", "")
        aj("\cch\ssc", "FRCCH0194", "HP OMNIBOOK XE3, G�raldine ROFFIDAL", "", "")
        ...
        aj("\cch\ssc", "FRCCH9504", "COMPAQ ARMADA E500, Marl�ne DUDZIK", "", "")
        ...
        aj("\cli", "FRCLI0016", "PC Ta�wannais P III 600, fabienne_blin", "", "")
        ...
        aj("\evr", "FREVR0004", "IBM T40, Jos� CORREIA", "", "")
        ...
        aj("\leh", "FRLEH0001", "IBM M42, Secr�tariat Industrie HARFLEUR", "", "")
        aj("\lro", "FRLRO0001", "Toshiba SP4200, Contr�leur AGR", "", "")
        aj("\mtz", "FRMTZ0001", "IBM M42, Franck ROTELLA", "", "")
        aj("\osy", "FROSY0001", "IBM T30, En attente Nom Utilisateur (Alphatest,"","")", "", "")
        aj("\osy", "FROSY0002", "IBM M42, Fr�d�ric LAUTI (Alphatest,"","")", "", "")
        ...
        aj("\qxb", "FRQXB0014", "IBM M42, Mich�le GEORGES", "", "")
        aj("\qxb", "FRQXB0015", "IBM T30, Val�rie MIDENA", "", "")
        ...
        aj("\qxb", "FRQXB9802", "Portable, Magali COUZON, acc�s RS-6000", "", "")
        aj("\rou", "FRCCH0031", "IBM T30, C�dric ADAM (Rouen,"","")", "", "")
        aj("\rou", "FRROU0001", "IBM T40, St�pane Joly", "", "")
    ...
    Private Sub IEDoc_DocumentComplete(sender As System.Object, e As AxSHDocVw.DWebBrowserEvents2_DocumentCompleteEvent) Handles IEDoc.DocumentComplete
        ...
        d.body.innerHTML = "Selectionnez le site � analyser (exemple: cch) et cliquez sur le bouton Analyser."
    End Sub

    ' Utilitaire: rafa�chit la fen�tre IE
    Sub RefreshIE()
        Do
    ...
    Sub AfficheMachines(slOU As SortedList, slComputers As SortedList, sSite As String, bListeXX As Boolean)
        ' Si la liste est vide, on d�gage sans traitement
        ...
        ' On d�termine le mini et le maxi de la collection � afficher
        ...
        While enumComp.MoveNext
            ...
            Else
                ...
                iComp = CInt(m.Groups(1).Value)  ' L'indice 0 est le match de la Chaîne compl�te
            End If
            iMin = System.Math.Min(iMin, iComp)
            iMax = System.Math.Max(iMax, iComp)
        End While

        ' iMin0 = d�but d'affichage. L'affichage commence aux valeurs 1,11,21,31...
        Dim iMin0 As Integer
        iMin0 = iMin - (iMin - 1) Mod 10

        ' On remplit le tableau de compupters.
        ' iRang-1 donne le rang de l'OU dans slOU de fa�on
        ' � afficher avec la bonne couleur, ou 0 s'il n'y a pas d'ordinateur, ou -1 si inconnu
    ...
    Sub aj(sPos As String, sComputer As String, sDescription As String, sWhenCreated As String, sWhenChanged As String)
        ...
        ' On d�termine la Clé du site, la partie avant le premier \
        Dim sKey As String
        Dim pBS As Integer
        pBS = sPos.IndexOf("\"c)
        ...
        ' On recherche le site dans slSitesAD en le cr�ant si besoin est
        Dim sad As SiteAD
        ...
        ' Mise � jour de la liste des sous-OUs du site
        If Not sad.slOU.Contains(sPos) Then sad.slOU.Add(sPos, Nothing)

        ' Analyse du nom de machine de fa�on � l'ajouter dans la bonne liste
