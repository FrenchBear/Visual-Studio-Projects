...
#Region " Code g�n�r� par le Concepteur Windows Form "
    ...
    <DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As New Resources.ResourceManager(GetType(frmAnalyseUsers))
...
#End Region
    ...
    Private Sub btnAnalyse_Click(sender As System.Object, e As EventArgs) Handles btnAnalyse.Click
        ...
        ' On commence par Récup�rer la liste des sites
        RécupListeSites()
    ...
    Sub AnalyseUser(sPos As String, u As Object)
        ...
        ' Récup�ration de la liste des groupes
