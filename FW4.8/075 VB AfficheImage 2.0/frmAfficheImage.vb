...
#Region " Code g�n�r� par le Concepteur Windows Form "
    ...
    <DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnPremier.ToolTipText = "Premi�re image (D�but)"
        '
        'btnPrécédent
        '
        ...
        Me.btnDernier.ToolTipText = "Derni�re image (Fin)"
        '
        'sep3
        '
...
#End Region
    ...
    Private Sub frmAfficheImage_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmdPremier.Text = "Pre&mier" & vbTab & "D�but"
        ...
        If iRowSize <> iNewRowSize Then
            If tImage IsNot Nothing Then
                ...
                For i = iRowSize * iRowSize To UBound(tImage)
                    ...
                    tImage(i) = Nothing
                Next
                'MsgBox("apr�s: " & Me.Controls.Count)
            End If
