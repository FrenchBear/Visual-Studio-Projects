...
internal class Program
{
    ...
    private static void Test_sha_256(string s, string hashed)
    {
        ...
        Debug.Assert(SHA_256_PV(s) == hashed);
    ...
    private static void Test_sha_224(string s, string hashed) =>
        // Use local implementation
        Debug.Assert(SHA_224_PV(s) == hashed);// .Net Framework does not provide a managed version

    private static void Test_sha_512(string s, string hashed)
    {
        // Use local implementation
        Debug.Assert(SHA_512_PV(s) == hashed);
    ...
    {
        // Use local implementation
        Debug.Assert(SHA_384_PV(s) == hashed);
    ...
    private static string SHA_256_PV(string s)
    {
    ...
    private static string SHA_224_PV(string s)
    {
        // Initialize hash values:
    ...
    private static string SHA_512_PV(string s)
    {
        // Initialize hash values:
    ...
    private static string SHA_384_PV(string s)
    {
        // Initialize hash values:
