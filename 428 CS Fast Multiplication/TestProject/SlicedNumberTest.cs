...
namespace TestProject
{
    ...
    public class SlicedNumberTest
    {
        ...
        {
            SlicedNumber target = new SlicedNumber("1");
        ...
        {
            string s = "1";
            SlicedNumber target = new SlicedNumber(s);
        ...
        {
            SlicedNumber target = new SlicedNumber("123");
        ...
        {
            SlicedNumber n1 = new SlicedNumber("8");
            SlicedNumber n2 = new SlicedNumber("7");
            SlicedNumber expected = new SlicedNumber("56");
            SlicedNumber actual;
        ...
        {
            SlicedNumber n = new SlicedNumber("12345123456789");
        ...
        public void AddTest()
        {
            SlicedNumber n1 = new SlicedNumber("8");
            SlicedNumber n2 = new SlicedNumber("7");
            SlicedNumber expected = new SlicedNumber("15");
            SlicedNumber actual;
        ...
        public void SubtractTest()
        {
            SlicedNumber n1 = new SlicedNumber("8");
            SlicedNumber n2 = new SlicedNumber("7");
            SlicedNumber expected = new SlicedNumber("1");
            SlicedNumber actual;
