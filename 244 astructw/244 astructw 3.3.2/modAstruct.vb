...
Module modAstruct
    ...
    Public bCopyDirectoryJunctionContent As Boolean ' Copy what is behind a reparse point (a junction on NTFS volumes)
...
#End Region
    ...
    Public Sub astruct(ByVal sSource As String, ByVal sDest As String)
        ...
        If bCopyDirectoryJunctionContent Then sOptions = sOptions & ", CopyJunctionContent"
            ...
            If Not colFilesDest.Contains(fiSource.Name) Then
                ...
                If Not bNoAction Then
                    If bDotNetCalls Then
                        ...
                        End Try
                    Else
                        Dim bRet As Integer = CopyFile(sWidePath(sSource & fiSource.Name), sWidePath(sDest & fiSource.Name), False)
            ...
            Do
                If findinfo.dwFileAttributes And FileAttributes.Directory Then
                    ...
                    If (findinfo.dwFileAttributes And FileAttributes.Hidden) <> FileAttributes.Hidden OrElse (findinfo.dwFileAttributes And FileAttributes.System) <> FileAttributes.System Then
                        If bCopyDirectoryJunctionContent Or (findinfo.dwFileAttributes And FileAttributes.ReparsePoint) <> FileAttributes.ReparsePoint Then
