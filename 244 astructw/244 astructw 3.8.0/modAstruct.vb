...
Module modAstruct
    ...
    Public colExclusionsFolders As New Collection       ' List of patterns to ignore for folders
    Public colExclusionsFiles As New Collection         ' List of patterns to ignore for folders
